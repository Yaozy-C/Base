...
//    std::unique_ptr<FileLogger> fileLogger = nullptr;
    ...
    Logger &Logger::stream(const std::string &file, std::size_t line, const std::string &func) {
        std::string info;
        switch (_level) {
            case LOGLEVEL::trace:
                _stream << "[" << GetTime() << "][" << green << "TRACE" << normal << "][" << std::this_thread::get_id()
                        << "][" << file + ":" << func << "() " << line << "] ";
                break;
            case LOGLEVEL::debug:
                _stream << "[" << GetTime() << "][" << black << "DEBUG" << normal << "][" << std::this_thread::get_id()
                        << "][" << file + ":" << func << "() " << line << "] ";
                break;
            case LOGLEVEL::info:
                _stream << "[" << GetTime() << "][" << blue << "INFO " << normal << "][" << std::this_thread::get_id()
                        << "][" << file + ":" << func << "() " << line << "] ";
                break;
            case LOGLEVEL::warn:
                _stream << "[" << GetTime() << "][" << yellow << "WARN " << normal << "][" << std::this_thread::get_id()
                        << "][" << file + ":" << func << "() " << line << "] ";
                break;
            case LOGLEVEL::error:
                _stream << "[" << GetTime() << "][" << red << "ERROR" << normal << "][" << std::this_thread::get_id()
                        << "][" << file + ":" << func << "() " << line << "] ";
                break;
            default:
                break;
